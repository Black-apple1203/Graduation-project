    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            <div class="td" style=" width:33%;">
                <div class="left_padding striking">
                    <input name="tuid[]" type="checkbox" id="id" value="<?php echo ($vo['uid']); ?>"/><?php echo ($vo['username']); ?>
                    <?php if($vo['avatars'] != ''): ?><span class="pictip vtip" title="<img src='<?php echo attach($vo['avatars'],'avatar');?>' border=0 align=absmiddle width=120 height=120>">&nbsp;&nbsp;&nbsp;&nbsp;</span><?php endif; ?>
            ...
            <div class="td center" style=" width:10%;"><?php echo admin_date($vo['reg_time']);?></div>
            ...
            <div class="td edit" style=" width:20%;">
                ...
                <a href="javascript:void(0);" class="blue personal_log" parameter="uid=<?php echo ($vo['uid']); ?>">日志</a>
...
<div class="list_foot">
    <div class="btnbox">
        <input type="button" class="admin_submit" id="ButAdd" value="添加会员" onclick="window.location.href='<?php echo U('member_add');?>'"/>
    ...
    $(document).ready(function () {
        ...
        $("#ButDel").click(function () {
            if (confirm('删除会员，该会员下简历、企业、职位信息将同步删除')) {
                $("form[name=form1]").attr("action", "<?php echo U('member_delete');?>");
