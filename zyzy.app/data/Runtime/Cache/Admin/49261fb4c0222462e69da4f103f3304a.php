...
<head>
	...
	<script>
		var URL = '/index.php/Admin/ResumeImg',
			SELF = '/index.php?m=Admin&amp;c=ResumeImg&amp;a=index',
...
<form id="form1" name="form1" method="post" action="<?php echo U('delete');?>">
    ...
    <div class="imglist">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="li">
                ...
                <a href="javascript:void(0);" class="audit" id="setAudit" data-param="id[]=<?php echo ($vo['id']); ?>&utype=2">
                ...
                <a href="<?php echo attach($vo['img'],'resume_img');?>" target="_blank">
                    <img src="<?php echo attach($vo['img'],'resume_img');?>" border="0" align="absmiddle" />
                </a>
                <div class="imgfoot link_w">
                    <div class="date"><?php echo (date("Y-m-d H:i",$vo["addtime"])); ?></div>
                    <div class="manager"><a href="javascript:void(0);" class="userinfo" parameter="uid=<?php echo ($vo['uid']); ?>&utype=2" hideFocus="true">管理</a></div>
                    <div class="del"><a href="<?php echo U('delete',array('id'=>$vo['id']));?>" onclick="return confirm('你确定要删除吗？')">删除</a></div>
                </div>
    ...
    <div class="footso">
        <form action="?" method="get">
            <div class="sobox">
                ...
                <input name="key_type_cn" id="J_key_type_cn" type="hidden" value="<?php echo ((_I($_GET['key_type_cn']) != "")?(_I($_GET['key_type_cn'])):'简历标题'); ?>"/>
                <input name="" type="submit" value="" class="sobtn"/>
                <div class="sotype" id="J_key_click"><?php echo ((_I($_GET['key_type_cn']) != "")?(_I($_GET['key_type_cn'])):'简历标题'); ?></div>
