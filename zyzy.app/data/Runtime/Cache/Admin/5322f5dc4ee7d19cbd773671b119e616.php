...
<head>
	...
	<script>
		var URL = '/index.php/Admin/CompanyInterview',
			SELF = '/index.php?m=Admin&amp;c=CompanyInterview&amp;a=index',
...
<div class="clear"></div>
    <div class="list_th">
        ...
        <div class="td center" style=" width:20%;">基本信息</div>
        <div class="td center" style=" width:20%;">职位名称</div>
        <div class="td center" style=" width:20%;">企业名称</div>
        <div class="td center" style=" width:10%;">面试时间</div>
        <div class="td center" style=" width:20%;">面试详情</div>
        <div class="clear"></div>
    </div>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            ...
            <div class="td center" style=" width:20%;">
                <a href="<?php echo ($vo['jobs_url']); ?>" target="_blank"><?php echo ($vo['jobs_name']); ?></a>
            </div>
            <div class="td center" style=" width:20%;">
                <a href="<?php echo ($vo['company_url']); ?>" target="_blank"><?php echo ($vo['company_name']); ?></a>
            </div>
            <div class="td center" style=" width:10%;">
                <?php echo date('Y-m-d H:i', $vo['interview_time']);?>
            </div>
            <div class="td center" style=" width:20%;">
                <span style="color: #009900" class="vtip" title="<?php echo ($vo['interview_tip']); ?>">
                    [详情]
                </span>
            </div>
            <div class="clear"></div>
            ...
            <div class="sobox">
                ...
                <div class="mlist" id="J_mlist">
                    <ul>
                        ...
                        <li id="3" title="职位名">职位名</li>
                        <li id="4" title="职位ID">职位ID</li>
                        <li id="5" title="姓名">姓名</li>
                    </ul>
                </div>
            </div>
        </form>
