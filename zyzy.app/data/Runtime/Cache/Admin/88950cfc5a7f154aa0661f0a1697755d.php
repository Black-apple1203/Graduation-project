...
<head>
	...
	<script>
		var URL = '/index.php/Admin/ResumeDown',
			SELF = '/index.php?m=Admin&amp;c=ResumeDown&amp;a=index',
...
<div class="clear"></div>
    <div class="list_th">
        ...
        <div class="td center" style=" width:25%;">基本信息</div>
        <div class="td center" style=" width:25%;">企业名称</div>
        <div class="td center" style=" width:25%;">下载时间</div>
        <div class="clear"></div>
    </div>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            ...
            <div class="td center" style=" width:25%;">
                <a href="<?php echo ($vo['company_url']); ?>" target="_blank"><?php echo ($vo['company_name']); ?></a>
            </div>
            <div class="td center" style=" width:25%;">
                <?php echo admin_date($vo['down_addtime']);?>
            </div>
            <div class="clear"></div>
