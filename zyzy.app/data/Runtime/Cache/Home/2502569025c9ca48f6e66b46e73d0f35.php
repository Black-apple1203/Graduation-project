        ...
        $.getJSON("<?php echo U('Members/sign_in');?>",function(result){
  		...
  		<div class="mainbox">
			...
			<div class="tab">
				...
				<a class="li J_hoverbut" href="<?php echo U('personal/resume_privacy');?>">屏蔽企业</a>
			...
			<div class="safety J_hoverbut link_blue">
				...
				<div class="td2">上次登录时间：<span><?php if($visitor['last_login_time']): echo date('Y-m-d H:i:s',$visitor['last_login_time']); else: ?>从未登录<?php endif; ?></span></div>
