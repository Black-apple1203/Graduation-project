	...
	<!-- -->
		...
		<div class="mright">
			<div class="user_pagetitle">
				...
				<!--<div class="pat_r">系统保留三个月的记录，共<strong> <?php echo ($favorites['count']); ?> </strong>条</div>-->
				<div class="clear"></div>
			</div>
			...
			<form id="form1" class="J_allListBox" action="<?php echo U('del_resume_favorites');?>" method="post">
			<?php if(!empty($favorites['list'])): if(is_array($favorites['list'])): $i = 0; $__LIST__ = $favorites['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="resume_favorites">
				<div class="td1 link_blue substring">
					<input name="y_id[]" class="J_allList" type="checkbox" value="<?php echo ($vo['did']); ?>"> &nbsp;<a href="<?php echo ($vo['resume_url']); ?>" target="_blank" title="<?php echo ($vo['fullname']); ?>"><?php echo ($vo['fullname']); ?></a>
    			</div>
    			...
    			<div class="td4"><?php echo fdate($vo['favorites_addtime']);?></div>
    			<div class="td5 link_blue">
    				<a href="javascript:;" url="<?php echo U('del_resume_favorites',array('y_id'=>$vo['did']));?>" class="delete">删除</a>
    			</div>
    			<div class="clear"></div>					
