			...
			<div class="mright">
				<div class="gold_top_gold">
					<div class="gold h125">
						<div class="rightbox">
							<div class="txt">
								<a class="name"><?php echo ($company_profile['companyname']); ?></a>
								<div class="imgbox">
									<?php if(($$company_profile['audit']) == "1"): ?><div class="company_v"></div><?php endif; ?>
									<?php if($my_setmeal['setmeal_id'] > 1): ?><div class="company_vip"><img src="<?php echo attach($my_setmeal['setmeal_id'].'.png','setmeal_img');?>" alt="<?php echo ($my_setmeal['setmeal_name']); ?>" /></div><?php endif; ?>
									<?php if(($$company_profile['famous']) == "1"): ?><div class="company_bao"><img src="<?php if(C('qscms_famous_company_img') == ''): echo attach('famous.png','resource'); else: echo attach(C('qscms_famous_company_img'),'images'); endif; ?>" alt="" /></div><?php endif; ?>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
							</div>
							<div class="txt link_blue"><span class="gray">我的套餐：</span><strong><?php echo ($my_setmeal['setmeal_name']); ?></strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('setmeal_detail');?>">套餐使用明细</a></div>
                            <div class="txt nomt link_blue"><span class="gray">服务期限：
                            </span><?php echo date('Y-m-d',$my_setmeal['starttime']);?> — <?php if($my_setmeal['endtime'] == 0): ?>永久<?php else: echo date('Y-m-d',$my_setmeal['endtime']); endif; ?></div>
						</div>
						<div class="clear"></div>
					</div>
					<div class="package_head h125">
						<div class="head_txt link_yellow"><a href="<?php echo U('explain');?>" target="_blank">VIP会员享受更多招聘特权</a></div>
						<div class="head_block_group">
							<div class="head_block">
								<div class="block icon1">职位数：<strong><?php echo ($my_setmeal['surplus_jobs']); ?></strong></div>
							</div>
							<div class="head_block">
								<div class="block icon2">简历点数：<strong><?php echo ($my_setmeal['download_resume']); ?></strong></div>
							</div>
							<?php if(C('qscms_company_sms') == 1): ?><div class="head_block">
								<div class="block icon3">短信数：<strong><?php echo ($my_userinfo['sms_num']); ?></strong></div>
							</div><?php endif; ?>
							<div class="head_block">
								<div class="block icon4">剩余天数：<span class="number"><?php echo ($leave_days); ?></span></div>
							</div>
							<div class="clear"></div>
						</div>
					</div>
				...
				<div class="service_pack_group package">
					<?php if(is_array($setmeal_list)): $i = 0; $__LIST__ = $setmeal_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="service_pack_list">
						<div class="list_box J_hoverbut">
							<div class="list_box_package_type"><div class="package_icon"><img src="<?php echo attach($vo['id'].'.png','setmeal_img');?>" alt="<?php echo ($vo['setmeal_name']); ?>" /><span class="meal_name"><?php echo ($vo['setmeal_name']); ?></span></div></div>
							<div class="list_box_contents"><div class="price"><span class="num"><?php echo ($vo['expense']); ?></span><div class="month"><?php echo ($vo['long']); ?></div></div></div>
							<div class="package_list_group">
								<div class="package_line odd">
									<div class="line_left">发布职位数</div>
									<div class="line_right"><?php echo ($vo['jobs_meanwhile']); ?></div>
									<div class="clear"></div>
								</div>
								<div class="package_line">
									<div class="line_left">下载简历点数</div>
									<div class="line_right"><?php echo ($vo['download_resume']); ?></div>
									<div class="clear"></div>
								</div>
								<div class="package_line odd">
									<div class="line_left">赠送<?php echo C('qscms_points_byname');?></div>
									<div class="line_right"><?php echo ($vo['set_points']); ?></div>
									<div class="clear"></div>
								</div>
								<div class="package_line for_hoverbox">
									<div class="line_left">增值服务专享折扣</div>
									<div class="line_right highlight"><?php echo ($vo['discount']); ?> 折</div>
                                    <div class="hoverbox">
                                        <div class="des_box">
                                            <div class="desarrow"></div>
                                            <div class="box_list_group">
                                                <div class="box_list">
                                                    <div class="b_left">下载简历点数</div>
                                                    <div class="b_right"><?php if($vo['discount_download_resume'] > 0): echo ($vo["discount_download_resume"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div class="box_list">
                                                    <div class="b_left">短信增值包</div>
                                                    <div class="b_right"><?php if($vo['discount_sms'] > 0): echo ($vo["discount_sms"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div class="box_list">
                                                    <div class="b_left">职位置顶</div>
                                                    <div class="b_right"><?php if($vo['discount_stick'] > 0): echo ($vo["discount_stick"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div class="box_list">
                                                    <div class="b_left">职位紧急</div>
                                                    <div class="b_right"><?php if($vo['discount_emergency'] > 0): echo ($vo["discount_emergency"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div class="box_list">
                                                    <div class="b_left">企业模板</div>
                                                    <div class="b_right"><?php if($vo['discount_tpl'] > 0): echo ($vo["discount_tpl"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                                <div class="box_list">
                                                    <div class="b_left">职位预约刷新</div>
                                                    <div class="b_right"><?php if($vo['discount_auto_refresh_jobs'] > 0): echo ($vo["discount_auto_refresh_jobs"]); ?> 折<?php else: ?>无<?php endif; ?></div>
                                                    <div class="clear"></div>
                                                </div>
                                            </div>
                                        </div>
								...
								<?php if(C('qscms_company_sms') == 1): ?><div class="package_line odd">
									<div class="line_left">短信条数</div>
									<div class="line_right"><?php echo ($vo['set_sms']); ?></div>
									<div class="clear"></div>
								</div><?php endif; ?>
							</div>
							<div class="btn_yellow J_hoverbut btn_190_38" onclick="javascript:location.href='<?php echo U('setmeal_add',array('id'=>$vo['id']));?>'">立即购买</div>
						</div>
